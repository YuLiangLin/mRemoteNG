...
- Fixed update checks failing to parse Nightly and `-yll` application versions.
- Preserved native RDP fullscreen and hid its unsupported minimize action, which could leave the main window on a blank connection surface.
